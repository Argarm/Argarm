...
![Open to work](https://img.shields.io/badge/Open%20to%20work-Remote%20Europe-brightgreen?style=flat)
...
|------|----------------------|
| [OmniSearch](https://github.com/Argarm/OmniSearch) | Production RAG system — FastAPI, Qdrant, LangChain, multi-provider LLM (OpenAI + Claude), PDF/Notion/Confluence ingestion |
| [Pregonero](https://github.com/Argarm/Pregonero) | LLM-filtered RSS digest bot — TypeScript/Bun, Groq, Telegram, GitHub Actions scheduler |
